...
import viruswiper.game.zombie.animations.HealthRecoveryZombieBossAnimations
import viruswiper.game.zombie.types.HealthRecoveryZombie
import kotlin.math.pow
import kotlin.random.Random

class HealthRecoveryZombieBoss(context: Context, entityHandler: EntityHandler) :
    HealthRecoveryZombie(context, entityHandler) {
